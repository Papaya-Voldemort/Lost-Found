...
const translations = {
    en: {
        common: {
            ...
            submittedPending: 'Item submitted! It will appear after admin approval.',
        ...
        lost: {
            ...
            describeCategoryPlaceholder: 'e.g. Lunchbox, sports gear, art supplies',
            dateLost: 'Date Lost',
        ...
        admin: {
            title: 'Admin Panel',
            subtitle: 'Review and manage item submissions.',
            pending: 'Pending',
            active: 'Active',
            totalItems: 'Total',
            pendingQueue: 'Pending Queue',
            allItems: 'All Items',
            noPending: 'No items awaiting review.',
            noItems: 'No items in the system.',
            approve: 'Approve',
            reject: 'Reject',
            approveConfirmTitle: 'Approve Item',
            approveConfirmMsg: 'Make this item visible to the public?',
            rejectConfirmTitle: 'Reject Item',
            rejectConfirmMsg: 'Reject and permanently delete this item?',
            deleteConfirmTitle: 'Delete Item',
            deleteConfirmMsg: 'Permanently delete this item? This cannot be undone.',
            approved: 'Item approved and now visible.',
            approveFailed: 'Failed to approve item.',
            rejected: 'Item rejected and removed.',
    ...
    es: {
        common: {
            ...
            submittedPending: 'Objeto enviado. Aparecerá tras la aprobación del administrador.',
            passwordStrength: ['', 'Débil', 'Regular', 'Buena', 'Fuerte', 'Muy fuerte'],
        },
        nav: { home: 'Inicio', lost: 'Perdidos', found: 'Encontrados', signIn: 'Iniciar sesión', account: 'Cuenta', admin: 'Admin' },
        home: {
            documentTitle: 'Traceback',
        ...
        lost: {
            ...
            describeCategory: 'Describe la categoría',
            describeCategoryPlaceholder: 'ej. Lonchera, equipo deportivo, materiales de arte',
        ...
        admin: {
            ...
            subtitle: 'Revisar y gestionar las publicaciones.',
            pending: 'Pendiente',
            active: 'Activo',
            totalItems: 'Total',
            pendingQueue: 'Cola de Pendientes',
            allItems: 'Todos los Objetos',
            noPending: 'No hay objetos pendientes de revisión.',
            noItems: 'No hay objetos en el sistema.',
            approve: 'Aprobar',
            reject: 'Rechazar',
            approveConfirmTitle: 'Aprobar Objeto',
            approveConfirmMsg: '¿Hacer visible este objeto al público?',
            rejectConfirmTitle: 'Rechazar Objeto',
            rejectConfirmMsg: '¿Rechazar y eliminar permanentemente este objeto?',
            deleteConfirmTitle: 'Eliminar Objeto',
            deleteConfirmMsg: '¿Eliminar permanentemente este objeto? Esta acción no se puede deshacer.',
            approved: 'Objeto aprobado y visible.',
            approveFailed: 'No se pudo aprobar el objeto.',
            rejected: 'Objeto rechazado y eliminado.',
            rejectFailed: 'No se pudo rechazar el objeto.',
            loadFailed: 'No se pudieron cargar los objetos.',
        }
    },
    fr: {
        common: {
            ...
            submittedPending: 'Objet soumis ! Il apparaîtra après approbation.',
            passwordStrength: [
                '',
                'Faible',
                'Équitable',
        ...
        lost: {
            ...
            describeCategory: 'Décrire la catégorie',
            describeCategoryPlaceholder: 'par ex. Boîte à lunch, équipement sportif, fournitures artistiques',
        ...
        admin: {
            ...
            subtitle: 'Vérifier et gérer les soumissions.',
            pending: 'En attente',
            active: 'Actif',
            totalItems: 'Total',
            pendingQueue: 'File d\'attente',
            allItems: 'Tous les objets',
            noPending: 'Aucun objet en attente.',
            noItems: 'Aucun objet dans le système.',
            approve: 'Approuver',
            reject: 'Rejeter',
            approveConfirmTitle: 'Approuver l\'objet',
            approveConfirmMsg: 'Rendre cet objet visible au public ?',
            rejectConfirmTitle: 'Rejeter l\'objet',
            rejectConfirmMsg: 'Rejeter et supprimer définitivement cet objet ?',
            deleteConfirmTitle: 'Supprimer l\'objet',
            deleteConfirmMsg: 'Supprimer définitivement cet objet ?',
            approved: 'Objet approuvé et visible.',
            approveFailed: 'Échec de l\'approbation.',
            rejected: 'Objet rejeté et supprimé.',
    ...
    it: {
        common: {
            ...
            submittedPending: 'Oggetto inviato! Apparirà dopo l\'approvazione.',
            passwordStrength: [
                '',
                'Debole',
                'Giusto',
        ...
        lost: {
            ...
            describeCategory: 'Descrivi la categoria',
            describeCategoryPlaceholder: 'per esempio. Portapranzo, attrezzatura sportiva, materiale artistico',
        ...
        admin: {
            ...
            subtitle: 'Revisiona e gestisci le pubblicazioni.',
            pending: 'In attesa',
            active: 'Attivo',
            totalItems: 'Totale',
            pendingQueue: 'Coda in attesa',
            allItems: 'Tutti gli oggetti',
            noPending: 'Nessun oggetto in attesa di revisione.',
            noItems: 'Nessun oggetto nel sistema.',
            approve: 'Approva',
            reject: 'Rifiuta',
            approveConfirmTitle: 'Approva oggetto',
            approveConfirmMsg: 'Rendere visibile questo oggetto?',
            rejectConfirmTitle: 'Rifiuta oggetto',
            rejectConfirmMsg: 'Rifiutare e eliminare definitivamente?',
            deleteConfirmTitle: 'Elimina oggetto',
            deleteConfirmMsg: 'Eliminare definitivamente questo oggetto?',
            approved: 'Oggetto approvato e visibile.',
            approveFailed: 'Approvazione fallita.',
            rejected: 'Oggetto rifiutato ed eliminato.',
    ...
    hi: {
        common: {
            ...
            submittedPending: 'वस्तु सबमिट हो गई! प्रशासक की मंजूरी के बाद दिखेगी।',
            passwordStrength: ['', 'कमज़ोर', 'ठीक-ठाक', 'अच्छा', 'मज़बूत', 'बहुत मज़बूत'],
        },
        nav: { home: 'होम', lost: 'खोया', found: 'मिला', signIn: 'साइन इन', account: 'खाता', admin: 'एडमिन' },
        home: {
            documentTitle: 'Traceback',
        ...
        lost: {
            ...
            describeCategory: 'श्रेणी का वर्णन करें',
            describeCategoryPlaceholder: 'उदा. लंचबॉक्स, खेल का सामान, कला सामग्री',
        ...
        admin: {
            title: 'एडमिन पैनल',
            subtitle: 'सबमिशन की समीक्षा और प्रबंधन करें।',
            pending: 'लंबित',
            active: 'सक्रिय',
            totalItems: 'कुल',
            pendingQueue: 'लंबित कतार',
            allItems: 'सभी वस्तुएँ',
            noPending: 'कोई वस्तु समीक्षा के लिए नहीं।',
            noItems: 'सिस्टम में कोई वस्तु नहीं।',
            approve: 'स्वीकृत',
            reject: 'अस्वीकृत',
            approveConfirmTitle: 'वस्तु स्वीकृत करें',
            approveConfirmMsg: 'इस वस्तु को सार्वजनिक करें?',
            rejectConfirmTitle: 'वस्तु अस्वीकृत करें',
            rejectConfirmMsg: 'अस्वीकृत और स्थायी रूप से हटाएं?',
            deleteConfirmTitle: 'वस्तु हटाएं',
            deleteConfirmMsg: 'इस वस्तु को स्थायी रूप से हटाएं?',
            approved: 'वस्तु स्वीकृत और दृश्यमान।',
            approveFailed: 'स्वीकृति विफल।',
            rejected: 'वस्तु अस्वीकृत और हटाई गई।',
    ...
    zh: {
        common: {
            ...
            submittedPending: '物品已提交！管理员审核后将显示。',
            passwordStrength: ['', '弱', '一般', '良好', '强', '非常强'],
        },
        nav: { home: '首页', lost: '失物', found: '招领', signIn: '登录', account: '账户', admin: '管理' },
        home: {
            documentTitle: 'Traceback',
        ...
        lost: {
            ...
            category: '类别',
            selectCategory: '选择类别',
            describeCategory: '描述类别',
            describeCategoryPlaceholder: '例如：午餐盒、运动装备、美术用品',
            dateLost: '丢失日期',
            location: '最后出现地点',
            selectLocation: '选择地点',
        ...
        admin: {
            ...
            approve: '通过',
            reject: '拒绝',
            approveConfirmTitle: '通过物品',
            approveConfirmMsg: '确定让该物品公开显示？',
            rejectConfirmTitle: '拒绝物品',
            rejectConfirmMsg: '拒绝并永久删除该物品？',
            deleteConfirmTitle: '删除物品',
            deleteConfirmMsg: '永久删除该物品？此操作不可撤销。',
            approved: '物品已通过并公开显示。',
            approveFailed: '通过失败。',
            rejected: '物品已拒绝并删除。',
            rejectFailed: '拒绝失败。',
    ...
    ar: {
        common: {
            ...
            submittedPending: 'تم إرسال الغرض! سيظهر بعد موافقة المشرف.',
            passwordStrength: ['', 'ضعيف', 'مقبول', 'جيد', 'قوي', 'قوي جدًا'],
        },
        nav: { home: 'الرئيسية', lost: 'مفقودات', found: 'معثورات', signIn: 'تسجيل الدخول', account: 'الحساب', admin: 'الإدارة' },
        home: {
            documentTitle: 'Traceback',
        ...
        lost: {
            ...
            describeCategory: 'صف الفئة',
            describeCategoryPlaceholder: 'مثل: علبة غداء، معدات رياضية، أدوات فنية',
        ...
        admin: {
            title: 'لوحة الإدارة',
            subtitle: 'مراجعة وإدارة المنشورات.',
            pending: 'قيد الانتظار',
            active: 'نشط',
            totalItems: 'الإجمالي',
            pendingQueue: 'قائمة الانتظار',
            allItems: 'جميع الأغراض',
            noPending: 'لا توجد أغراض بانتظار المراجعة.',
            noItems: 'لا توجد أغراض في النظام.',
            approve: 'موافقة',
            reject: 'رفض',
            approveConfirmTitle: 'الموافقة على الغرض',
            approveConfirmMsg: 'هل تريد جعل هذا الغرض مرئيًا للعامة؟',
            rejectConfirmTitle: 'رفض الغرض',
            rejectConfirmMsg: 'رفض وحذف هذا الغرض نهائيًا؟',
            deleteConfirmTitle: 'حذف الغرض',
            deleteConfirmMsg: 'حذف هذا الغرض نهائيًا؟ لا يمكن التراجع.',
            approved: 'تمت الموافقة وأصبح مرئيًا.',
            approveFailed: 'فشلت الموافقة.',
            rejected: 'تم رفض الغرض وحذفه.',
...
function translateItemForms(prefix) {
    ...
    setText(`label[for="category-other"]`, `${key}.describeCategory`);
    setAttr('#category-other', 'placeholder', `${key}.describeCategoryPlaceholder`);
